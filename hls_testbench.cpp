...
int main(int argc, char** argv)
{
  ...
  unsigned stride  = ceil(width/32.0)*32;
  ...
  unsigned char *y_dst = (unsigned char *)malloc(MAX_IMAGE_WIDTH/2*MAX_IMAGE_HEIGHT/2);
  ...
  unsigned num_coefs_padded = (((num_coefs-1)/8)+1)*8;
  ...
  printf("Running SW implementation\n");
